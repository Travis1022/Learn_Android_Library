...
public abstract class ViewBinder<D extends Dispatch> implements ViewModelBridge {
     ...
     */
    protected void bindService(Class<? extends Service> targetClass, ServiceConnection connection) {
        ((DispatchActivity) mDispatch).bindService(targetClass, connection);
    }
}
