 ...
 */
public abstract class AbstractExpandableAdapterItem<T extends Serializable> extends AbstractAdapterItem<T> {
    ...
    public AbstractExpandableAdapterItem(Context context) {
        super(context);
    }
    ...
    public void onUpdateViews(T model, int position) {
        ...
        if (model instanceof ExpandableListItem) {
            ...
            onExpansionToggled(mExpandableListItem.isExpanded());
        }
    }
